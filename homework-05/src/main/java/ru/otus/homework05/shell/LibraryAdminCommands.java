...
public class LibraryAdminCommands {
    ...
    private final String MESSAGE_EMPTY_RESULT_SET = "message.EmptyResultSet";
    private final String MESSAGE_NO_ROWS_DELETED = "message.NoRowsDeleted";
    ...
    public void deleteEntity(@ShellOption(value = {"-t", "--entity-type"}, defaultValue = "book") String entityType,
                             @ShellOption(value = "-v", defaultValue = ShellOption.NONE) int value) {
        try {
            switch (entityType) {
                case "book":
